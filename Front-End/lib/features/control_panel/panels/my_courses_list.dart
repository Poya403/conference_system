...
class _MyCoursesListState extends State<MyCoursesList> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<Map<String, dynamic>>>(
      future: coursesService.myCoursesList(),
                              ...
                              Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    const SizedBox(height: 6),
                                    DeleteButton(courseId: courseList['cid']),
                                  ],
                                ),
                              ),
                            ],
...
class DeleteButton extends StatelessWidget {
  const DeleteButton({super.key, required this.courseId});
  final int courseId;
  @override
  Widget build(BuildContext context) {
    final coursesService = CoursesService();
    return ElevatedButton(
      onPressed: () async {
        await coursesService.deleteCourse(context, courseId);
      },
